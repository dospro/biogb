...
using Cartridge = std::variant<RomOnly, MBC1, MBC2, MBC3, MBC5>;
...
public:
    ...
    [[nodiscard]] Cartridge get_cartridge_interface();
...
private:
    ...
    static constexpr bool has_mbc_battery(u8 mbc_id) noexcept;
